...
class PaymentGatewayTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of PaymentGateway
        //val modelInstance = PaymentGateway()
        ...
        // to test the property `gatewayId`
        should("test gatewayId") {
            // uncomment below to test the property
            //modelInstance.gatewayId shouldBe ("TODO")
        }
