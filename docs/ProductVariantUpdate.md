...
| **productId** | [**java.util.UUID**](java.util.UUID.md) | The parent product this variant belongs to. References the product entity. |  [optional] |
| **sku** | **kotlin.String** | Variant-specific SKU (must be unique per tenant). |  [optional] |
